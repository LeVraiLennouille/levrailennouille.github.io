...
<footer class="Footer">
    ...
    <div class="FooterContainer">
        ...
        <div class="FooterCol">
            ...
            <ul class="FooterLinks FooterSocialLinks">
                <li><a href="https://linkedin.com/in/lennouille/" target="_blank" rel="noopener noreferrer">
                ...
                <li><a href="https://instagram.com/lennouille.fr/" target="_blank" rel="noopener noreferrer">
                    <span class="FooterIcon">
                ...
                <li><a href="https://github.com/LeVraiLennouille/" target="_blank" rel="noopener noreferrer">
                    <span class="FooterIcon">
    ...
    <div class="FooterBottom">
        ...
        <div class="FooterTerms">
            <ul class="FooterLinks">
                <li><a href="/terms/mentions-legales">Mentions légales</a></li>
                <li><a href="/terms/politique-confidentialite">Politique de confidentialité</a></li>
                <li><a href="/terms/cgu">CGU</a></li>
            </ul>
